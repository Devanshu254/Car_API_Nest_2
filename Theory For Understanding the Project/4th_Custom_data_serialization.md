...
## Video 68: Controller wide serialization.
> Last Two Steps.
> First thing we will take care of is making sure that we apply this decorator not just to this one request handler but to all the handlers inside our controller.
